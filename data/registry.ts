...
export const calculators: CalculatorEntry[] = [
  ...
  // LOANS
  {
    ...
    seo: { title: 'Loan Calculator', description: 'Calculate monthly loan payments, total interest, and the full cost of any fixed-rate loan. Free loan calculator with instant results.', keywords: ['loan calculator', 'loan payment calculator', 'amortization calculator'] },
    featured: true,
    icon: 'Landmark',
  },
  {
  ...
  },
  {
    ...
    description: 'See how extra monthly payments shorten a loan and cut the total interest you pay.',
    route: '/mortgage/mortgage-amortization-calculator',
    relatedTools: ['mortgage-calculator', 'loan-calculator', 'debt-payoff-calculator'],
    seo: { title: 'Mortgage Amortization Calculator', description: 'Calculate mortgage payoff time and total interest, and see how much extra monthly payments save. Free amortization calculator with extra payment analysis.', keywords: ['mortgage amortization', 'mortgage payoff calculator', 'extra mortgage payment calculator'] },
    featured: false,
    icon: 'Table',
  },
  // SAVINGS
